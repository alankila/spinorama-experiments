...
<template>
  <div class="grid gap-4 bg-spinorama-bg-darker justify-center p-4 auto-fit-cols">
    <div class="pb-4 rounded-lg shadow grid items-center justify-items-center grid-rows-1 auto-rows-max gap-2 overflow-hidden bg-spinorama-bg" v-for="[speakerId, speaker] of Object.entries(metadata)">
